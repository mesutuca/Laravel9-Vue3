<template>
  <div>
    <button type="button" id="headlessui-listbox-button-4">
      <span class="dark:hidden" v-if="!darkMode">
        <svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-6 h-6"><path
            d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" class="fill-sky-400/20 stroke-sky-500"></path>
  ...
  <div class="theme-switch-wrapper">
    <label class="theme-switch" for="checkbox">
      <input type="checkbox" id="checkbox" v-model="darkMode" @change="toggleMode">
    </label>
  </div>
</template>
...
const currentTheme = localStorage.getItem("color-theme") ? localStorage.getItem("color-theme") : null;
